                                                ...
                                                <div class="review-content-section">
                                                    <div class="card-block">
                                                        <form action="#" method="post">
                                                            <div class="input-group mg-b-15 mg-t-15" style="width:200px">
                                                                <span class="input-group-addon"><i class="icon" aria-hidden="true"></i></span>
                                                                <input type="text" class="form-control" placeholder="Car Name" style="margin-left:-20px" name="carDetails">
                                                            </div>
                                                            <div class="input-group mg-b-15">
                                                                <select class='form-control ' name="carType">
                                                                    <?php
                                                                    $fetchComp = "SELECT DISTINCT car_type from car_category";
                                                                    $fetchRes = mysqli_query($connect, $fetchComp);
                                                                    while ($rowF = mysqli_fetch_array($fetchRes)) {
                                                                        echo "<option value='" . $rowF['car_type'] . "'>" . $rowF['car_type'] . "</option>";
                                                                    }
                                                                    ?>
                                                                </select>
