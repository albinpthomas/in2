                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                ...
                                <li><a title="Business List" href="addcategory.php"><span class="mini-sub-pro">Add New category</span></a></li>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="header-top-wraper">
                                <div class="row">
                                    ...
                                    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 " style="float:right;margin-right:20px;">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php
                                                if ($row['items_status'] == 1) {
                                                    echo ('<button data-toggle="tooltip" title="Trash" type="submit" name="del" class="pd-setting-ed" value="' . $row['items_id'] . '"><i class="fa fa-times" aria-hidden="true"></i> Deactivate</button>
                                            ');
                                                } else {
                                                    echo ('<button data-toggle="tooltip" title="Trash" type="submit" name="act" class="btn btn-success" value="' . $row['items_id'] . '"><i class="fa fa-check" aria-hidden="true"></i> Activate</button>
                                            ');
                                                }
                                                ?>
        </form>
...
if (isset($_POST['del'])) {
    ...
    echo ('
        <script>
        window.location.href="other-items.php";
        </script>');
}
if (isset($_POST['act'])) {
    include "../include/dbconnect.php";
    $id = $_POST['act'];
    $query = "UPDATE tbl_items SET items_status = 1 WHERE items_id = '$id'";
    $res = mysqli_query($connect, $query);
    echo ('
        <script>
        window.location.href="other-items.php";
